...
/* Authentication type */
    ...
    if (isset($_SESSION['nickname']) && $_SESSION['status'] != 'admin') {
        $cfg['Servers'][$i]['user'] = 'user_'.$_SESSION['id'];
        $cfg['Servers'][$i]['password'] = $_SESSION['dbpass'];
    }
    // $cfg['Servers'][$i]['user'] = 'user_2';
    // $cfg['Servers'][$i]['password'] = 'USAmustdie2050';
    // $cfg['Servers'][$i]['only_db'] = 'user_2\_%';
    // $cfg['Servers'][$i]['only_db'] = 'user_2\_%';
    $cfg['Servers'][$i]['hide_db'] = 'information_schema';
    $cfg['Servers'][$i]['LogoutURL'] = 'http://adeptx.tk/';
