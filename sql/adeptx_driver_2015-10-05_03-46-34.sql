...
-- 
-- Table structure for table `adeptx_phrase` 
-- 

DROP TABLE IF EXISTS `adeptx_phrase`;
CREATE TABLE `adeptx_phrase` (
`id` int(15) NOT NULL auto_increment,
...
`date_sent` timestamp DEFAULT '2015-10-04 20:08:41' NOT NULL,
`was_read` tinyint(1),
  PRIMARY KEY  (`id`)
